...
import { avatarImages } from "./SidebarConstant";
    ...
    <section className="flex min-h-[258px] w-full flex-col justify-between rounded-[14px] bg-[#1C1F2E] px-5 py-8 xl:max-w-[568px]">
      ...
      <article className={cn("flex justify-center relative", {})}>
        <div className="relative flex w-full max-sm:hidden">
          ...
          <div className="flex justify-center items-center  absolute left-[136px] size-10 rounded-full border-[5px] border-[#252A41] bg-[#1E2757]">
            +5
          </div>
        </div>
        {!isPreviousMeeting && (
